...
import PostHeader from '@/components/posts/post-item/post-header'
import PostStatus from '@/components/posts/post-item/post-status'
import PostActions from '@/components/posts/post-item/post-actions'
import PostComments from '@/components/posts/post-item/post-comments'
import PostDescription from '@/components/posts/post-item/post-description'
import PostUpdatedAt from '@/components/posts/post-item/post-updated'
import PostItem from '@/components/posts/post-item'
import ErrorDisplay from '@/components/ui/error-display'
import { Post } from '@/types/logo'
